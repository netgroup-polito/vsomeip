...
static constexpr vsomeip::method_t BENCH_SERVICE_METHOD_ID = 0x8421;
static constexpr vsomeip::method_t BENCH_SERVICE_METHOD_ID_SHUTDOWN = 0x7777;

static constexpr vsomeip::event_t BENCH_SERVICE_EVENT_ID = 0x8778;
static constexpr vsomeip::event_t BENCH_SERVICE_EVENTGROUP_ID = 0x4465;
